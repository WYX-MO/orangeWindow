...
class ScreenshotTool:
    ...
    def one(self):
        ...
        print("当前坐标：", self.subwindow_x, self.subwindow_y)  # 最新坐标
...
class RegAndTranser:
    ...
    def detect_text_boxes(self, image1):
        ...
        while i < len(contours) - 1:
            ...
            print("test1:" + str(x) + " " + str(y) + " " + str(w) + " " + str(h) + " | " + str(x_next) + " " + str(
                y_next) + " " + str(w_next) + " " + str(h_next))
            # 判断是否应该合并
